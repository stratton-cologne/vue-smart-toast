<template>
    <div class="notifications-container">
        <template v-for="pos in uniquePositions" :key="pos">
            <div class="toasts-wrapper" :class="pos">
                <transition-group appear :name="getTransitionName(pos)" tag="div" class="toasts-list" :class="pos">
                    <div v-for="toast in toastsByPosition[pos]" :key="toast.id" class="toast" :class="toast.type"
